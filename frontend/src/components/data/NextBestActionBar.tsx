...
export const NextBestActionBar: React.FC<NextBestActionBarProps> = ({
  ...
  return (
    <aside
      ...
      className="fixed bottom-0 left-0 right-0 z-40 border-t border-slate-200 bg-white/95 px-6 py-3 backdrop-blur-md shadow-lg transition-all"
    >
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="flex items-center gap-3.5">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-amber-50 border border-amber-200 text-amber-700 shadow-2xs">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600">{action.explanation}</p>
          </div>
        </div>
